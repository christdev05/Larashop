                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="" id="" placeholder="Search..." wire:model='searchTerm'>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.editproduct',['product_slug'=>$product->slug])}}" class=""><i class="fa fa-edit fa-2x"></i></a>
