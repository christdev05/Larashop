                                    ...
                                    @if(Auth::user()->utype === 'ADM')
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                ...
                                                <li class="menu-item">
                                                    <a title="Manage Home Slider" href="{{ route('admin.homeslider') }}">Manager Home Slider</a>
                                                </li>
                                                <li class="menu-item">
...
<script src="https://cdn.tiny.cloud/1/a6p5zkr4f59w8c6nd2yub3fjknnct4few18oxyc6k2m4cb84/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
